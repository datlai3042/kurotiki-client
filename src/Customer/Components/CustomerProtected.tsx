...
export default function AccountProtectionCard({ onActivate, imageSrc = '/security-lock.png' }: AccountProtectionCardProps) {
      return (
            <section className='relative isolate w-full max-w-[390px] overflow-hidden rounded-[20px] border border-blue-100/70 bg-gradient-to-br from-[#f8fbff] via-[#f1f6ff] to-[#e9f1ff] p-5 shadow-[0_10px_30px_rgba(37,99,235,0.08)]'>
                  ...
                  <div className=' z-10 flex min-h-[158px] items-center gap-3'>
                        <div className='min-w-0 flex-1'>
                              <h3 className='text-[18px] font-bold leading-6 text-slate-900'>Bảo vệ tài khoản của bạn</h3>
                              ...
                              >
                                    Kích hoạt ngay
                                    <ArrowRight size={17} strokeWidth={2.2} className='transition-transform group-hover:translate-x-1' />
                              </button>
                        </div>

                        <div className='absolute right-[12px] bottom-[12px] flex w-[125px] shrink-0 items-center justify-center self-stretch'>
                              ...
                              <img
                                    ...
                                    className=' z-10 w-[120px] select-none object-contain drop-shadow-[0_12px_15px_rgba(37,99,235,0.16)]'
                                    draggable={false}
                              />
                        </div>
                  </div>
