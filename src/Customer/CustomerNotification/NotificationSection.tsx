...
import { Check, Circle, Clock8, Inbox, Store, User } from 'lucide-react'
...
const NotificationSection = (props: TProps) => {
      ...
      return (
            <div className='relative mb-[80px] h-max min-h-[50px] w-full text-text-theme xl:mb-0'>
                  <div className='overflow-hidden rounded-2xl border border-[var(--border-color-input)] bg-color-section-theme shadow-[0_8px_30px_rgba(15,23,42,0.05)]'>
                        <div className='flex items-center justify-between border-b border-[var(--border-color-input)] px-5 py-4'>
                              <div>
                                    <h3 className='text-base font-semibold text-text-theme'>Thông báo cá nhân</h3>
                                    <p className='mt-1 text-xs text-slate-500'>Các cập nhật liên quan trực tiếp đến tài khoản của bạn</p>
                              </div>
                              ...
                              <div className='flex items-center gap-2 rounded-full bg-blue-50 px-3 py-1.5 text-xs font-medium text-blue-600'>
                                    ...
                                    <span>
                                          {getMyNotification.data?.pages.reduce(
                                                (total, page) =>
                                                      total + page.data.metadata.notifications.notification.notifications_message.length,
                                                0,
                                          ) || 0}{' '}
                                          thông báo
                                    </span>
                                    ...
                                    page.data.metadata.notifications.notification.notifications_message.map((notification) => {
                                          ...
                                          return (
                                                <div
                                                      ...
                                                      className={`group relative flex w-full gap-4 px-5 py-5 transition-colors ${
                                                            isRead
                                                                  ? `bg-color-section-theme ${
                                                                          theme === 'dark' ? 'hover:bg-[#0e1423]' : 'hover:bg-[#3197ee3d]'
                                                                    }`
                                                                  : `bg-color-section-theme ${
                                                                          theme === 'dark' ? 'hover:bg-[#0e1423]' : 'hover:bg-[#3197ee3d]'
                                                                    }`
                                                ...
                                                >
                                                      ...
                                                      <div className='min-w-0 flex-1'>
                                                            <div className='flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between'>
                                                                  <div className='min-w-0 flex-1'>
                                                                        ...
                                                                        {notification.notification_attribute.notification_type ===
                                                                              ...
                                                                              <div className='mt-1.5 flex gap-3'>
                                                                                    ...
                                                                                    <div className='min-w-0'>
                                                                                          <p className='text-sm font-semibold leading-6  px-2 rounded bg-blue-100 text-blue-600'>
                                                                                                {
                                                                                                      notification.notification_attribute
                                                                                                            .notification_content
                                                                                                }
                                                                                          </p>
                                                                                          <p className='mt-1 truncate text-sm text-blue-600 text-text-theme'>
                                                                                                {
                                                                                                      notification.notification_attribute
                                                                                                            .product_name
                                                                                                }
                                                                        ...
                                                                        {notification.notification_attribute.notification_type ===
                                                                              ...
                                                                              >
                                                                                    <div className='flex w-full mt-[8px] items-start gap-4'>
                                                                                          {/* Ảnh sản phẩm */}
                                                                                          <div className='flex h-[76px] w-[76px] shrink-0 items-center justify-center overflow-hidden rounded-xl border border-slate-200 bg-white p-1 shadow-sm'>
                                                                                                {notification.notification_attribute
                                                                                                      .product_id?.product_thumb_image ? (
                                                                                                      <img
                                                                                                            src={
                                                                                                                  notification
                                                                                                                        .notification_attribute
                                                                                          ...
                                                                                          <div className='min-w-0 flex-1'>
                                                                                                ...
                                                                                                <p className='mt-1 line-clamp-1 text-sm text-text-theme font-semibold'>
                                                                                                      {
                                                                                                            notification
                                                                                                                  .notification_attribute
                                                                                                                  .product_name
                                                            ...
                                                            <div className='mt-3 flex flex-wrap justify-end items-center gap-x-4 gap-y-2'>
                        ...
                        {!getMyNotification.isPending &&
                              !getMyNotification.data?.pages.some(
                                    (page) => page.data.metadata.notifications.notification.notifications_message.length > 0,
                              ) && (
                                    <div className='flex min-h-[320px] flex-col items-center justify-center px-6 text-center'>
                                          ...
                                          <h4 className='mt-4 text-sm font-semibold text-text-theme'>Chưa có thông báo cá nhân</h4>
                        ...
                        <div className='flex justify-center border-t border-[var(--border-color-input)] px-5 py-4'>
                              <button
