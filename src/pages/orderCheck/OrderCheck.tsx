...
const OrderCheck = () => {
      ...
      return (
            <div className='flex items-start mx-auto gap-[32px] my-[28px]'>
                  <div className='w-[720px] mx-auto bg-[#ffffff] flex flex-col p-[24px_16px_50px] xl:p-[24px_20px_50px]'>
                  ...
                  <button
                        ...
                        className='sticky top-[100px] p-[6px_8px] rounded-[4px] opacity-80 hover:opacity-100 bg-color-main text-[#fff]'
                  >
                        In Hóa đơn
                  </button>
            </div>
...
const OrderPdf = forwardRef<HTMLDivElement, { carts: CartProduct[]; orders: OrderItem }>(({ carts, orders }, ref) => {
      const user = useSelector((state: RootState) => state.authentication.user) as UserResponse
                        ...
                        <div className='relative 2'>
                              <div className='flex flex-col gap-[36px] p-[12px] print:p-[16px_42px]'>
                                    <div className='flex flex-col gap-[20px]'>
                                          <div className='flex justify-center font-semibold gap-[6px]'>
                                                <span>Ngày in hóa đơn</span>
                                                <span>-</span> {now}
                                          </div>
                                          <div className='text-color-main flex justify-center font-semibold gap-[6px]'>
                                                      ...
                                                      <div className='flex flex-col h-max gap-[40px]'>
                                                            <div className='  flex items-start justify-between  gap-[6px]'>
                                                                  <div className='flex flex-col items-end gap-[12px]'>
                                                                        <p className='flex text-color-main items-center gap-[8px]'>
                                                                              ...
                                                                              <span className=' font-bold text-[18px]'>Nhà cung cấp</span>
                                                                        </p>
                                                                        <img
                                                                              src={
                                                            ...
                                                            <div className='flex flex-col gap-[20px]'>
                                                                  <div className='flex text-color-main items-center gap-[8px]'>
                                                                        <CircleUser size={20} />
                                                                        <span className='font-bold text-[18px]'>Thông tin người mua</span>
                                                                  </div>
