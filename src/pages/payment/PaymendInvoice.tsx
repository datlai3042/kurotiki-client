            ...
            <div className='flex flex-col  mx-auto gap-[50px] '>
                  <div className='w-full flex flex-wrap justify-center items-center gap-[8px]'>
                        ...
                        <button
                              ...
                              className='whitespace-pre sticky top-[100px] h-[32px] px-[6px] rounded-[4px] opacity-80 hover:opacity-100 bg-color-main text-[#fff]'
                        >
                              In Hóa đơn
                        </button>
                  </div>
                  <div className=' max-w-[100%]  bg-[#ffffff] flex flex-col '>
                        <>
                              <React.Fragment>
